...
export default function Messenger() {
    ...
    useEffect(()=>{
        const getConversations=async ()=>{
            try{
                const res=await axios.get(`${API_BASE_URL}/conversations/${user._id}`);
    ...
    useEffect(()=>{
        const getMessages=async ()=>{
            try{
                const res=await axios.get(`${API_BASE_URL}/messages/${currentChat?._id}`);
...
const handleUserClick = async (userId) => {
    try {
        const res = await axios.get(`${API_BASE_URL}/conversations/find/${user._id}/${userId}`);
        if (res.data) {
